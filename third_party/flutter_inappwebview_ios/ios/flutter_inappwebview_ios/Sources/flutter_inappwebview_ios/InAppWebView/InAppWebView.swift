...
public class InAppWebView: WKWebView, UIScrollViewDelegate, WKUIDelegate,
    ...
    public override func buildMenu(with builder: UIMenuBuilder) {
        ...
        // Kaijuan: when the host app disables the system context menu, do not
        // call super.buildMenu. Super is the only path that injects iOS 18.2+
        // "Copy Link with Highlight" (and related share/highlight items).
        // See readium/swift-toolkit#509 and canPerformAction(disableContextMenu).
    ...
    public static func preWKWebViewConfiguration(settings: InAppWebViewSettings?) -> WKWebViewConfiguration {
        ...
        // Kaijuan: hide Apple Intelligence Writing Tools on the edit menu.
        // See readium/swift-toolkit#509.
