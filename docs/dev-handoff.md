...
> 更新时间：2026-07-22。本文是当前工作树交接，不是产品权威。功能看 [PRODUCT.md](./PRODUCT.md)，工程边界看 [ENGINEERING.md](./ENGINEERING.md)，Anx/Foliate 调研看 [research/anx-reader-architecture.md](./research/anx-reader-architecture.md)。
...
- 引入 Anx Reader 基线 commit `107f4fa74db0e7247c846c49d6211df3edf9887c` 的 Foliate 资源，保留许可证和来源说明：`assets/anx_reader/`。
...
7. 修改 `assets/anx_reader/foliate-js/src/book.js` 后执行：

   ```sh
   cd assets/anx_reader/foliate-js
   npm run build
   ```
...
| probe 页面 | `assets/anx_reader/foliate-js/metadata-probe.html` |
| probe 解析/抽样 | `assets/anx_reader/foliate-js/src/metadata-probe.js` |
| 隐式 allowScript 来源 | `assets/anx_reader/foliate-js/src/epub.js`，`Loader` constructor |
...
| Foliate 阅读入口 | `assets/anx_reader/foliate-js/src/book.js` |
| 架构研究 | `docs/research/anx-reader-architecture.md` |
