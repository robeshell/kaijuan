...
import 'ai_structure_supplements.dart';
...
class AiContentRuleWords {
  ...
  static const defaultAppendixUnits = defaultAiStructureAppendixUnits;

  static const defaultMetadataUnits = defaultAiStructureMetadataUnits;
