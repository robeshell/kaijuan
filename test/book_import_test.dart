...
<nav>
  <ol>
    <li><a href="chap1.xhtml">$title</a></li>
  </ol>
</nav>
</body>
</html>''');
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:identifier id="uid">urn:test:image</dc:identifier>
    <dc:language>zh</dc:language>
  </metadata>
  <manifest>
    <item id="nav" href="nav.xhtml" media-type="application/xhtml+xml" properties="nav"/>
...
<html xmlns="http://www.w3.org/1999/xhtml"><head><title>Image Only</title></head>
<body><nav><ol><li><a href="p1.png">p1</a></li></ol></nav></body></html>''');
...
void main() {
  ...
  setUp(() async {
    ...
    probe = FakeEpubImportProbe((_) => reflowSnapshot());
  ...
  test('import reflow EPUB as kind=book with content-hash dedup', () async {
    ...
    probe.handler = (_) => reflowSnapshot(title: '小说');
  ...
  test('image-only EPUB fails book import with friendly reason', () async {
    ...
    probe.handler = (_) =>
        throw const FoliateImportException('页图式 EPUB 请使用漫画引擎');
